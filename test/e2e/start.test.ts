...
async function testAbout(t: ExecutionContext<any>) {
  {
    ...
    t.is(about.comms.fixedAdapter, "ws-room:ws://localhost:8001/mini-comms/room-1", "lambdas server URL properly configured")
  }
  {
    ...
    t.is(about.comms.fixedAdapter, "ws-room:wss://127.0.0.1:8001/mini-comms/room-1", "lambdas server URL properly configured")
  }
}
